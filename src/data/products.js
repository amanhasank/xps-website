    ...
    pages: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'text', value: 'Raw Material Used: 12.9 - 4135/4140 | 8.8/10.9 - 10B21/15B25.' }
        ]
      },
      {
        pageNumber: 3,
        ...
        content: [
          ...
          { type: 'text', value: 'Knurled head for finger grip fast assembly.' },
    ...
    pages: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'text', value: 'Forging: M3 to M27 by Cold Forging Process | M27 and Above by Hot Forging Process' },
          { type: 'text', value: 'Raw Material Used: 12.9 - 4135/4140 | 8.8/10.9 - 10B21/15B25' },
          { type: 'text', value: 'CSK is always fully threaded.' }
        ]
      },
      {
        pageNumber: 3,
        ...
        content: [
          ...
          { type: 'text', value: 'Controlled Hex Socket for maximum wrenching strength.' },
          { type: 'text', value: 'Smooth fillet radius to withstand head soundness.' },
          { type: 'text', value: 'High-grade alloy steel for good strength & wear resistance.' },
          { type: 'text', value: 'Uniform Socket depth for accurate key fit & higher torque.' },
          { type: 'text', value: 'Closely controlled threads under radius root process proper fit & depth assemblies.' },
          { type: 'text', value: 'Controlled mechanical properties for higher strength.' },
          { type: 'text', value: 'Controlled concentricity in totality to create a high resistance to lateral movements.' }
        ]
      }
    ]
  },
    ...
    pages: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'text', value: 'Raw Material Used: 12.9 - 4135/4140 | 8.8/10.9 - 10B21/15B25.' },
          { type: 'text', value: 'BHCS is always fully threaded.' }
        ]
      },
      {
        pageNumber: 3,
        ...
        content: [
          ...
          { type: 'text', value: 'Controlled mechanical properties for higher strength.' },
          { type: 'text', value: 'High grade alloy steel for good strength & wear resistance.' },
          { type: 'text', value: 'Smooth radiuses ensure easy handling to the user.' },
          { type: 'text', value: 'Controlled concentricity in totality to create a high resistance to lateral movements.' }
        ]
      }
    ]
    ...
    pages: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'text', value: 'Smooth fillet radius to withstand soundness.' },
          { type: 'text', value: 'Uniform & uninterrupted grain flow for greater strength.' },
          { type: 'text', value: 'Controlled mechanical properties for higher strength.' }
        ]
      }
